...
public interface NodeSetContext {
   ...
   * <p>
   * Explicit references are those that are defined explicitly in the {@link UANodeSet} file.
   *
   ...
   * <p>
   * Implicit references are those that are not defined explicitly in the {@link UANodeSet} file
